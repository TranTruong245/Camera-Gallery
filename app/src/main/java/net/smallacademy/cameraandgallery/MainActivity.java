...
public class MainActivity extends AppCompatActivity {
    ...
    public void saveImageToFirebase(View view) {
...
// lấy định dạng của ảnh trong gallery
...
//chuẩn bị và chạy Intent để chụp ảnh từ camera. Nó sử dụng FileProvider để tạo URI cho tệp ảnh.
